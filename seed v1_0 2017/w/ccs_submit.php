...
$result=mysql_query("SELECT * FROM registration_ccs where id=(SELECT MAX(id) FROM registration_ccs)")
...
if($mem==1)
{
mysql_query("INSERT INTO registration_ccs(team_number,members,name,email,contact,branch,year,living,college,payment,payee,event) VALUES('$team_no','$mem','$a1','$a2','$a3','$a4','$a5','$a6','$college','$payment','$payee','$event')")
or die(mysql_error());
}
...
$url="Location:ccs_success.php?t=".$time;
header ($url);
mysql_close($conn);
