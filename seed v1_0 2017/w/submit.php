...
$result=mysql_query("SELECT * FROM registration where id=(SELECT MAX(id) FROM registration)")
...
$team_no=$row['team_number']+1;

date_default_timezone_set('Asia/Kolkata');
$subject ="Informing about successful Registration - S.E.E.D";
$time = date("h").":".date("i").date("A")."	".date("d")."/".date("m")."/".date("Y");
...
<br><br><b><div style=\"color: rgb(238,19,19);\">Venue : </div><div style=\"color: purple\">Room No: 113(Seminar Hall),AB-3</div></b><br><br><div style=\"color: rgb(238,19,19);\"><b>Date:</b> 18th , 19th , 20th September.<br><br><b>Time:</b> 4pm to 7pm.<br><br><b>Please stay in touch.</b></div><br><br>Registration done at : ".$time;
...
mysql_query("INSERT INTO registration(team_number,members,name,email,contact,branch,year,living,college,payment,payee,event) VALUES('$team_no','$mem','$d1','$d2','$d3','$d4','$d5','$d6','$college','$payment','$payee','$event')")
or die(mysql_error());
mysql_query("INSERT INTO registration(team_number,members,name,email,contact,branch,year,living,college,payment,payee,event) VALUES('$team_no','$mem','$e1','$e2','$e3','$e4','$e5','$e6','$college','$payment','$payee','$event')")
or die(mysql_error());
$mailing=mail($a2, $subject, $message, $headers);
$mailing=mail($b2, $subject, $message, $headers);
$mailing=mail($c2, $subject, $message, $headers);
$mailing=mail($d2, $subject, $message, $headers);
$mailing=mail($e2, $subject, $message, $headers);
}

$url="Location:payment.php?t=".$team_no."&p=".$payment;
header ($url);
mysql_close($conn);
